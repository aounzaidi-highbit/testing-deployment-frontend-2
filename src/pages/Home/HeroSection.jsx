  ...
  return (
    <div className="xsm:px-8 bg-hero-background bg-no-repeat h-full" data-aos="zoom-in" data-aos-delay="300">
      <div className="flex justify-evenly items-center h-[80vh]">
        <div className="w-[40%]">
          ...
          <div className="flex items-center relative my-6">
            <input
              ...
              type="text"
              className="box-shadow text-[15px] focus:outline-none font-medium text-[#464F54] rounded-lg px-4 py-4 bg-white w-full border focus:border-Primary"
            ...
            >
              <button className="bg-Primary hover:bg-Hover text-2xl font-semibold px-6 py-3 xsm:w-16 text-white rounded-r-lg flex gap-2 items-center">
                <img
                  src={search}
        ...
        <img
          className="hidden lg:block w-3/12"
          src={brandsIcon}
          alt="brands-icon"
        />
      </div>
